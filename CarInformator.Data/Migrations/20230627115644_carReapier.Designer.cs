...
namespace CarInformator.Data.Migrations
{
    ...
    [Migration("20230627115644_carReapier")]
    partial class carReapier
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarCarInsuranceHistorian", b =>
                {
                    ...
                    b.Property<int>("InsuredCarsId")
                        .HasColumnType("int");

                    b.HasKey("InsuranceHistoriansId", "InsuredCarsId");

                    b.HasIndex("InsuredCarsId");
